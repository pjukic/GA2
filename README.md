...
<b>How to launch locally:</b> 

- Download the Server from https://github.com/StabiloTheMarker/guardian_server.git

- Follow the readme there and launch the server in DEBUG mode

- In the File src/main/java/guardianangel/GAServices.java change the baseUrl to the IP Address your machine was assigned in your local network

- In the same file adapt the base64PW to the debug pw. (The comments tell you which is which)

- Launch the App on an Android Phone in Debug mode (Emulator won't be able to connect to the Smart Watch)
