...
import guardianangel.PeriodicGuardianExporter;
import guardianangel.PeriodicGuardianUpdater;
...
public class GBApplication extends Application {
    ...
    public static void quit() {
        GB.log("Quitting GuardianAngel...", GB.INFO, null);
    ...
    public void onCreate() {
        ...
        //PJ: Pebble not needed currently
        //loadAppsPebbleBlackList();
        //loadCalendarsBlackList();

        // Enable periodic Guardian Events - Filip Change -
        PeriodicGuardianExporter.enablePeriodicExport(getApplicationContext());
        // Enable periodic App-update
        // PJ disabled
      //A12  PeriodicGuardianUpdater.enablePeriodicUpdate(getApplicationContext());



        /* PJ: comment out for background services
            ...
            try {
                ...
                GB.notify(NOTIFICATION_ID_ERROR,
                        new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_HIGH_PRIORITY_ID)
                                .setSmallIcon(R.drawable.guardian_img)
    ...
    public static DBHandler acquireDB() throws GBException {
        try {
            //PJ reduced 30 to 15
            if (dbLock.tryLock(15, TimeUnit.SECONDS)) {
                return lockHandler;
            }
    ...
    public String getVersion() {
        try {
            ...
            GB.log("Unable to determine Guardian Angel's version", GB.WARN, e);
            return "0.0.0";
        }
    }
    ...
    public String getNameAndVersion() {
        try {
            ...
            GB.log("Unable to determine Guardian Angel's name/version", GB.WARN, e);
            return "Guardian Angel";
        }
    }

    public static void saveLastDBSyncTimestamp(String prefName, GregorianCalendar sendReqCal) {
        SharedPreferences.Editor editor = sharedPrefs.edit();
        editor.putLong(prefName, sendReqCal.getTimeInMillis());
        //GB.log("===>saveLastDBSyncTimestamp - " + DateTimeUtils.formatDateTime(sendReqCal.getTime()));
        editor.apply();
    }
    public static long getLastDBSyncTimestamp(String preferenceKey) {
        long dbSyncTimestamp = sharedPrefs.getLong(preferenceKey, 0);
        return dbSyncTimestamp;
    }
