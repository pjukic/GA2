...
//    private static final Logger LOG = LoggerFactory.getLogger(Prefs.class);
    ...
    public static void putString(SharedPreferences.Editor editor, String preference, String value) {
        editor.putString(preference, value);
        editor.commit();
    }

    public static void putInt(SharedPreferences.Editor editor, String preference, int value){
        editor.putInt(preference, value);
        editor.commit();
    }


    public static void removeEntry(SharedPreferences.Editor editor, String preference) {
