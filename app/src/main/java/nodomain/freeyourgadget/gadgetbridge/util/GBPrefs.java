...
public class GBPrefs {
    public static final String AUTO_GUARDIAN_EXPORT_INTERVAL = "auto_export_interval_guardian";
    ...
    //PJ Database Timestamp keyword
    public static final String GADB_LASTTIMESTAMP = "gadb_lasttimestamp";
