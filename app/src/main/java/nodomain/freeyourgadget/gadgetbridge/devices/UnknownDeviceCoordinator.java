...
public class UnknownDeviceCoordinator extends AbstractDeviceCoordinator {
    ...
    private static final class UnknownSampleProvider implements SampleProvider {
        ...
        @Override
        public void addGBActivitySample(AbstractActivitySample activitySample, String token) {
        }

        @Override
        public void addGBActivitySamples(AbstractActivitySample[] activitySamples, String token) {
        }
